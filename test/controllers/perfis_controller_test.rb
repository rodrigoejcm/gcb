...
class PerfisControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create perfil" do
    assert_difference('Perfil.count') do
      post perfis_url, params: { perfil: { imagemPerfil: @perfil.imagemPerfil, usuario_id: @perfil.usuario_id } }
    end
  ...
  test "should update perfil" do
    patch perfil_url(@perfil), params: { perfil: { imagemPerfil: @perfil.imagemPerfil, usuario_id: @perfil.usuario_id } }
